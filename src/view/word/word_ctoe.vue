	...
	<el-card class="box-card">
		<template #header>
			<div class="card-header">
				...
				<input style="border-top:0;border-left:0;border-right:0;margin: px 0px;font-size: 30px;" type="text" class="in" v-model="answer"/>
		...
		<div class="text" style="padding:40px 0 0px 0">
			<input id="answer" hidden style="border-top:0;border-left:0;border-right:0;border-bottom: 0;margin: 0 20px;padding: 0px 0px;" readonly type="text" class="in" v-model="form.wordText"/>
			<div style="margin: 10px 20px;">单词释义：{{form.wordTranslation}}</div>
			<!-- <div style="margin: 10px 20px;">例句：{{form.wordExample}}</div> -->

		</div>
		<div class="holder">
		<el-button id="putVocabulary" class="b" type="primary" :icon="Search" hidden @click="centerDialogVisible = true">加入生词本</el-button>
