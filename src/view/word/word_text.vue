<template>
	...
	<el-card class="box-card">
		...
		<div class="holder">
			...
			<el-button class="b" type="primary" :icon="Search" @click="centerDialogVisible = true">加入生词本</el-button>
		...
		methods: {
			...
			getWord(wordId) {
				...
				axios({
					...
					// document.getElementById("audio").src=this.form.wordAudio
					this.aLoading = true
