<template>
	...
	<el-card class="box-card">
		...
		<div class="text" style="padding:40px 0 0px 0">
			单词释义：<input style="border-top:0;border-left:0;border-right:0;margin: 10px 20px;" type="text" class="in" v-model="answer"/>
			<input id="answer" style="border-top:0;border-left:0;border-right:0;margin: 10px 20px;border-bottom: 0;" hidden readonly type="text" class="in" v-model="form.wordStandard"/>
