<template class="main">
	...
	<!-- {{cloze.clozeText}} -->
		...
		<div class="right">
			<div class="question" id="cloze_question">
	...
	export default {
		...
		methods: {
			...
			getIds() {
				axios({
					method: "post",
					url: "http://localhost:8090/cloze/getAllClozeId",
					headers: {
			...
			getCloze(clozeId) {
				axios({
					...
					document.getElementById("cloze_left").innerHTML=this.cloze.clozeText
					document.getElementById("cloze_question").innerHTML=this.cloze.clozeQuestion
